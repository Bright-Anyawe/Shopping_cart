    ...
    <>
      <div>
        <div className="welcomePageContainer">
          ...
          <div className="homePagemageContainer">
            {/* <img
        ...
        <footer>
          <p>
            ...
            <NavLink to="shop" className='shopLink'>Start shopping now</NavLink> and experience the
            best in quality, variety, and convenience at Shop_ryt.
          </p>
        </footer>
      </div>
    </>
