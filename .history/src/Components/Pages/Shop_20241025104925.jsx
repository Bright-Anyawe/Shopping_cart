...
const Shop = () => {
  ...
  const increment = (e, itemId) => {
    ...
    const increaseQuantity = parseInt(sibling);
    console.log(increaseQuantity);

    
    // setQuantity((quantity[itemId] += increaseQuantity));

    setQuantity((prevQuantities => ({...prevQuantities, quantity[itemId]: increaseQuantity})));
  };

  const decrease = () =>
    setQuantity((prevQuantities) => parseInt(prevQuantities) - 1);
            ...
            <div className="container" key={item.id}>
              ...
              <div className="additionalInfoContainer">
                ...
                <div className="priceOrderEl">
                  <button className="orderBtn" onClick={(e) => addToCart(e)}>
                    Order now!
                  </button>
                </div>
              </div>
