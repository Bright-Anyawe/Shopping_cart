...
const Shop = () => {
  ...
  function addToCart(e, itemId, product) {
    ...
    const existingProductIndex = qtySummery.findIndex(product => product.productUrl === product.image)

    if(existingProductIndex !== -1) {
      const updateSummery = [...qtySummery];
      updateSummery[existingProductIndex].QtySelected += quantity[itemId]
