...
const Shop = () => {
  ...
  const { qtySummeryObject, qtySummery, setSummery, setQuantitySummeryObject } =
    useContext(QtySummeryContext);
  ...
  function addToCart(e, itemId, product) {
    ...
    handleSelectedProduct(itemId, product);
  }

  function handleSelectedProduct(itemId, product) {
    setSummery((summery) => [
      ...summery,
      {
