...
export function Header() {
  ...
  const { quantityCount, quantity } = useContext(QuantityContext);
  ...
  window.onscroll = function () {
    ...
    if (prevScrollPos > currentScrollPos) {
      document.querySelector(".headerContainer").style.top = "35px";
    } else {
      document.querySelector(".headerContainer").style.top = "-70px";
    }
