...
const Shop = () => {
  ...
  if (!context) {
    // If `context` is null, it means `QuantityContext.Provider` is missing
    console.error("QuantityContext is not available.");
    return null;
  }

  const { setQuantityCount, quantity, setQuantity } = context;
